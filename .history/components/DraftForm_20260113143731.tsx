    ...
    <div className="max-w-6xl mx-auto space-y-10">
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-xs px-4 py-2 bg-background border border-border rounded-md text-muted-foreground hover:bg-muted font-medium transition shadow-sm">
            결재선 설정
          </button>
        </div>
      ...
      {/* Info Banner */}
      <div className="bg-brand-blue1/5 border border-brand-blue1/20 p-5 rounded-lg flex items-start gap-3">
        <div className="bg-brand-blue1/10 p-1.5 rounded-full">
