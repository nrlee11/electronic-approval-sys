...
const Sidebar: React.FC<{ onNavigate?: (page: string) => void }> = ({
  ...
  return (
    <aside className="w-60 bg-background border-r border-border flex flex-col fixed top-14 left-0 bottom-0 z-20 transition-transform shadow-[0_-5px_30px_rgba(0,0,0,0.05)]">
      {/* Collapse Toggle */}
