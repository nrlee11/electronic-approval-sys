      ...
      <div className="flex items-center gap-6">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-[320px] p-0 overflow-hidden">
            ...
            {/* Action Buttons */}
            <div className="flex bg-muted border-t border-b border-border">
              <button className="flex-1 py-3 text-sm text-foreground hover:bg-muted hover:text-foreground transition-colors">
                로그아웃
              </button>
