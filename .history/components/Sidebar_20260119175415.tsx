    ...
    <aside className="w-60 bg-background border-r border-border flex flex-col fixed top-14 left-0 bottom-0 z-20 transition-transform shadow-md">
      ...
      <div className="border-b border-border">
        <button
          ...
          className="w-full h-[79px] flex items-center justify-between shadow-sm bg-background text-foreground font-bold px-6 rounded hover:bg-muted border border-transparent hover:border-border transition-all"
        >
          <span>기안작성</span>
