...
const DraftForm: React.FC = () => {
  ...
  const [isApprovalLineModalOpen, setIsApprovalLineModalOpen] = useState(false);
    ...
    <div className="max-w-6xl mx-auto space-y-10">
      ...
      <section>
        <div className="flex items-center justify-between mb-4 border-b border-border pb-2">
          ...
          <Button onClick={() => setIsApprovalLineModalOpen(true)}>
            결재선 설정
          </Button>
        </div>
          ...
          <div className="grid grid-cols-[100px_1fr] items-start gap-4">
            ...
            <div className="space-y-4">
              <div className="flex flex-wrap gap-3">
                <button className="w-10 h-10 flex flex-col items-center justify-center border-2 border-dashed border-input rounded-lg text-muted-foreground hover:border-primary hover:text-primary transition-all bg-muted/50">
                  <Paperclip size={18} />
                </button>
      ...
      <ApprovalLineModal
        isOpen={isApprovalLineModalOpen}
        onClose={() => setIsApprovalLineModalOpen(false)}
      />
    </div>
  );
};
