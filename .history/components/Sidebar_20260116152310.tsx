          ...
          {subItems.map((subItem) => (
            <li key={subItem}>
              <button
                ...
                className="w-full flex border-b border-border items-center px-10 py-2 text-xs text-muted-foreground hover:text-primary focus:text-primary hover:bg-muted transition-all"
              >
