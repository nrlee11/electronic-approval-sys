      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-background w-72">
                <DropdownMenuGroup>
                  ...
                  <DropdownMenuItem>진행중</DropdownMenuItem>
                  <DropdownMenuItem>반려</DropdownMenuItem>
                  <DropdownMenuItem>지출결의서(엑셀업로드형)</DropdownMenuItem>
                  <DropdownMenuItem>회의록</DropdownMenuItem>
                  <DropdownMenuItem>업무보고</DropdownMenuItem>
                </DropdownMenuGroup>
          ...
          <div className="flex items-center w-full">
            <label className="shrink-0 w-24 text-sm font-medium text-foreground">
              검색
            </label>
            <div className="flex flex-1 gap-2 items-center min-w-0">
              ...
              <Input className="flex-1 min-w-0 w-full" placeholder="기안제목 입력" />
            </div>
          </div>
        </div>
      </div>
