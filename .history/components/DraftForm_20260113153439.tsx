...
const DraftForm: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-10">
      ...
      {/* Info Banner */}
      <div className="bg-brand-blue1 border border-brand-blue1/20 p-5 rounded-lg flex items-start gap-3">
        <div className="bg-brand-blue1 opacity-100 p-1.5 rounded-full">
