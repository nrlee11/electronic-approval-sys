          ...
          <DropdownMenuContent align="end" className="w-[320px] p-0 overflow-hidden">
            ...
            <div className="p-5">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-full bg-brand-blue2 flex items-center justify-center text-white shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="px-2 py-0.5 rounded text-[11px] font-medium bg-brand-blue1/10 text-brand-blue1 shrink-0 border border-brand-blue1/20">
                      겸임
                    </span>
                  </div>
            ...
            {/* Action Buttons */}
            <div className="flex bg-muted/50 border-t border-b border-border">
              <button className="flex-1 py-3 text-sm text-foreground/70 hover:bg-muted hover:text-foreground transition-colors">
                로그아웃
              </button>
            ...
            <div className="p-5 pb-2">
              ...
              <div className="space-y-4">
                <button className="w-full flex justify-between items-center text-sm text-foreground/80 hover:text-foreground group transition-colors">
                  <span>결재선 관리</span>
                  <ChevronRight
                    size={16}
                ...
                <div className="w-full flex justify-between items-center text-sm text-foreground/80">
                  <span>결재암호</span>
                  <Switch />
                </div>
              </div>
