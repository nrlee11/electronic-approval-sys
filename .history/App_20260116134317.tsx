...
type PageType = "dashboard" | "submitted" | "approval" | "approval-progress" | "approval-completed" | "approval-rejected" | "forms" | "business-draft" | "completed" | "saved" | "rejected" | "returned" | "retrieved" | "pending-receipt" | "receipt-completed" | "document-register";
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const checkHash = () => {
      ...
      } else if (hash === "/approval" || hash === "approval") {
