        ...
        <table className="w-full text-sm border-collapse table-fixed">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="p-3.5 border-r border-border">SI 사업부</td>
              <td className="p-3.5">
                <div className="relative">
      ...
      <div className="mb-10">
        ...
        <div className="border border-border rounded-sm">
          <div className="grid grid-cols-12 border-b border-border">
            <div className="col-span-2 bg-muted font-medium text-muted-foreground p-3 text-sm font-medium text-muted-foreground border-r border-border flex items-center justify-center">기안제목</div>
