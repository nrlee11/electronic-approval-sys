  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-background">
      <div className="flex flex-1 overflow-hidden">
              ...
              <Table>
                ...
                <TableBody>
                  {sampleData.map((item, index) => (
                    <TableRow key={index} className="border-b border-red-500 hover:bg-example-content">
        ...
        <TableCell colSpan={6} className="text-left text-sm text-muted-foreground">
          추가 정보: {item.description}
        </TableCell>
      </TableRow>
                  ))}
                </TableBody>
