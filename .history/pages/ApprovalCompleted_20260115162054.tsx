              ...
              <Table>
                ...
                <TableBody>
                  {sampleData.map((item, index) => (
                    ...
                    <TableRow key={index} className="border-b border-border hover:bg-example-content">
                      <TableCell className="text-center">{item.docId}</TableCell>
                      <TableCell className="text-center">
                        {item.formType}
                      </TableCell>
                      <TableCell className="text-left">
                        <span className="cursor-pointer text-underline underline-offset-0">
                          {item.title}
                        </span>
                      </TableCell>
                      <TableCell className="text-center">
                    ...
                    <TableRow key={index} className="border-b border-border hover:bg-example-content">
                      ...
                      <TableCell className="text-left">
                        <span className="cursor-pointer hover:underline underline-offset-0">
                          {item.title}
                        </span>
                      </TableCell>
                      <TableCell className="text-center">
